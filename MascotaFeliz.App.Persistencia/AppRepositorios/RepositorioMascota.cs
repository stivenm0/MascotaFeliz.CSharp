    ...
    namespace MascotaFeliz.App.Persistencia
{
    public class RepositorioMascota : IRepositorioMascota
    {
        ...
        public int DeleteMascota(int idMascota)
        {
            int idH =0;
            var mascotaEncontrado = _appContext.Mascotas.Include("Historia").FirstOrDefault(d => d.Id == idMascota);
            if (mascotaEncontrado == null)
                return 0;

            if(mascotaEncontrado.Historia!=null){
             idH= mascotaEncontrado.Historia.Id;
            }
